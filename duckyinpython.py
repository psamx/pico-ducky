# License : GPLv2.0
# Copyright (c) 2024  Dave Bailey
# Authors: Dave Bailey (dbisu, @daveisu), Diego Contreras (@Desperationis), @psamx
...
class DuckyScript():
    ...
    # DuckyScript should be null if it fails to open the file
